...
.one {
  ...
  .o {
    width: calc(48% - 4px);
    background: linear-gradient(0deg, rgba(99, 163, 255, 0.2), rgba(22, 127, 255, 0.2) 50%, rgba(114, 190, 255, 0.2));
    display: flex;
    margin-bottom: 8px;
    .alert-line {
...
.title {
  ...
  .right {
    ...
    ._o {
      align-items: center;
      background-color: rgba(22, 127, 255, 0.2);
      display: flex;
      flex-direction: row;
      height: 22px;
      width: 90px;
      ...
      .active {
        background-color: rgba(22, 127, 255, 0.4);
        border-color: #167fff;
      }
    }
  }
